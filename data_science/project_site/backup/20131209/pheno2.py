...
#####
def get_degree_day(temp_tuple, base_temp=5):
...
#####
def get_degree_day_sum_wonline(zip_code, start_date, base_temp=5, end_date=None):
        
    if DEBUG: print "**EXEC: get_degree_day_sum_wonline(zip_code, start_date, base_temp=5, end_date=None)", \
        zip_code, start_date, base_temp, end_date
...
def get_degree_day_sum(zip_code, start_date, base_temp, end_date=None):
    ...
    try:
        return get_degree_day_sum_wonline(zip_code, start_date, base_temp, end_date)
    except:
        pass
...
def get_event_type_predictions(event_type, gdd_arr):
    ...
    elif  event_type == "start_of_fall_colors": #Beginning of fall colors
        model_file_name = "end_of_spring_model2007.pkl"    
    elif  event_type == "most_intense_fall_colors": #Most Intense Fall Colors
        model_file_name = "end_of_spring_model2007.pkl"
    elif  event_type == "end_of_leaf_drop": #End of leaf drop
        model_file_name = "end_of_spring_model2007.pkl"
...
#####
def get_start_date(end_date=None):
...
def get_predictions (lat, lng, end_date=None): 
    ...
    gdds = get_degree_day_sum(zip_code, START_DATE, BASE_TEMP, end_date)
    ...
    zip(gdds, event1_predictions,event2_predictions, event2_predictions, event2_predictions, event2_predictions):
